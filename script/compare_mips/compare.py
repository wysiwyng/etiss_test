...
<body>
<p><b>Status</b> (for commit ${current_hash})<b>:</b>

${message_tcc}<br/>

<b>Current dhrystone MIPS for TCCJIT</b> <b>:</b> ${new_mips_tcc}<br/>

<b>Previous best for TCCJIT</b> (recorded in commit ${best_hash})<b>:</b> ${best_mips_tcc}, difference ${f'{best_diff_tcc:+.2%}'}<br/>


<b>Status</b> (for commit ${current_hash})<b>:</b>
...
<b>Previous best for GCCJIT</b> (recorded in commit ${best_hash})<b>:</b> ${best_mips_gcc}, difference ${f'{best_diff_gcc:+.2%}'}<br/>
...
<b>Previous best for LLVMJIT</b> (recorded in commit ${best_hash})<b>:</b> ${best_mips_llvm}, difference ${f'{best_diff_llvm:+.2%}'}</br>
</body>
</html>
